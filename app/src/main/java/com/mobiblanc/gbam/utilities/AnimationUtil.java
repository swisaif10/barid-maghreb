...
public class AnimationUtil {
    ...
    public AnimationUtil(Float scaleFactor) {
    ...
    private AnimationUtil setOriginRect(float x, float y) {
        originX = x;
        originY = y;
        return this;
    }

    private AnimationUtil setDestRect(float x, float y) {
        destX = x;
        destY = y;
        return this;
    }
    ...
    public AnimationUtil setMoveDuration(int duration) {
    ...
    public AnimationUtil setAnimationListener(Animator.AnimatorListener listener) {
