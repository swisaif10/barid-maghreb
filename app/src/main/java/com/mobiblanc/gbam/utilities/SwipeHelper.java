...
public abstract class SwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public static class UnderlayButton {
        ...
        public void onDraw(Canvas c, RectF rect, int pos) {
            ...
            float deleteIconTop = rect.top + (cHeight - drawable.getIntrinsicHeight()) / 2;
            float deleteIconMargin = (cHeight - drawable.getIntrinsicHeight()) / 3;
            float deleteIconLeft = rect.right - deleteIconMargin - drawable.getIntrinsicWidth();
            float deleteIconRight = rect.right - deleteIconMargin;
            float deleteIconBottom = deleteIconTop + drawable.getIntrinsicHeight();
            drawable.setBounds((int) deleteIconLeft, (int) deleteIconTop, (int) deleteIconRight, (int) deleteIconBottom);
            drawable.draw(c);
            clickRegion = rect;
            this.pos = pos;
        }
